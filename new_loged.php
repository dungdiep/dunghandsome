...
<body>
    ...
    <div class="container product-show mt-5">
        <div class="col-md-5 mt-2">
            ...
            <a href="new_loged.php" style="text-decoration: none; color: #00483d; font-weight: 500;"><i
        ...
        <div class="row">
            <div class="col-sm-12 main-product">
                <div class="row">
                    ...
                    ?>
                    <div class="col-12 col-3 col-sm-4 mt-2 " data-aos="flip-up">
                        <div class="card" style="border-radius: 8px;">
                            <div class="card-body ">
                                ...
                                <a href="new_detail_loged.php?new_id=<?php echo $row['new_id']; ?>" class="new"
