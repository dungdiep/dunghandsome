...
$sql = 'SELECT * FROM new LIMIT ' . $offset . ', ' . $rowsPerPage;
$data = getData($sql);
...
if (isset($_POST["submit"])) {
 ...
 if (isset($_POST['new_content']))
     ...
     if (isset($_POST['content_full']))
        $content_full = trim($_POST["content_full"]);
    else $content_full   = "";
    ...
    if (
        $new_img == "" || $new_title == "" || $new_content == "" || $content_full == "" 
    ) {
        echo '<script>';
        ...
        $sql = "SELECT * from new where  new_title='$new_title' ";
        ...
        if (mysqli_num_rows($user)  > 0) {
            ...
            $sql = "INSERT INTO new ( new_id, new_img, new_title,new_content, content_full) 
            VALUES ( NULL,'$new_img','$new_title','$new_content','$content_full')";
                ...
                <nav class="sb-sidenav accordion " id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link " href="./new.php" style="color:orange">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                                    ...
                                                    <form class="container" action="" method="post">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="" style="font-family:times">Ảnh
                                                                tin tức </label></br>
                                                            <input class="input ml-4" type="file" id="gb"
                                                                name="new_img">
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-5">
                                                                <label for=""
                                                                    style="color: #008080; font-weight: bold;">Thông
                                                                    tin tóm tắt</label>
                                                            </div>
                                                            <div class="col-md-7">
                                                                <div class="form-group col-md-12">

                                                                    <textarea type="text" name="new_content" id=""
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-7">
                                                                <div class="form-group col-md-12">
                                                                    ...
                                                                    <textarea type="text" name="content_full" id=""
                                                                        class="form-control" placeholder=""
                                                                        aria-describedby="helpId"
                                                                        style="width: 80%"></textarea>
                                                                </div>
                                ...
                                if (isset($_GET['submit']) && $_GET["search"] != '') {
                                    ...
                                    WHERE (
                                        new_id like '$search' 
                                    OR new_title like '%$search%'
                                    OR new_content like '%$search%'
                                    OR content_full like '%$search%' )  order by new_id asc";
                                    ...
                                    if ($num > 0) {
                                        ...
                                        echo "<thead class='bg-success text-white'>
                                            <tr>
                                              <th scope='col' class='text-center'>Mã tin tức</th>
                                              <th scope='col' class='text-center'>Hình ảnh</th>
                                            <th scope='col' class='text-center'>Tiêu đề</th>
                                            <th scope='col' class='text-center'>Nôi dung</th>
                                            <th scope='col' class='text-center'>Nội dung đầy đủ</th>
                                        ...
                                        foreach ($sql as $row) {
                                            ...
                                            echo "<td class='text-center'>MTT{$row['new_id']}</td>";
                                            echo "<td><img src='./img/$row[new_img]' width='60px;' height='60px;'
                                                            style='margin: 10px auto; border-radius: 10px;'></td>";
                                            echo "<td class='text-center'>{$row['new_title']}</td>";
                                            echo "<td class='text-center'>{$row['new_content']}</td>";
                                            echo "<td class='text-center'>{$row['content_full']}</td>";
                                            echo "</tr>";
                                        }
                                        echo '</table>';
                                ...
                                <td><img src="img/' . $value[1] . '" width="100" height="100"></td>
                                <td>'  . $value[2] . '</td>
                                <td>'  . $value[3] . '</td>
                                <td>'  . $value[4] . '</td>
                                ...
                                <td class="text-center"> 
                                    ...
                                    <?php
                                $conn = new mysqli("localhost", "root", "", DATABASE);
                                $re = mysqli_query($conn, 'select * from new');
