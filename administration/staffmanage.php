...
$sql = 'SELECT * FROM account where level=1 LIMIT ' . $offset . ', ' . $rowsPerPage;
$data = getData($sql);
...
if (isset($_POST["submit"])) {
    ...
    if (
        ...
        if (mysqli_num_rows($user)  > 0) {
            ...
            $sql = "INSERT INTO account ( id, username, fullname, email, phone, address, level) 
            VALUES ( NULL,'$username','$fullname','$email','$phone', '$address','1') ";
            ...
            <nav class="sb-sidenav accordion " id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link " href="./staffmanage.php" style="color:orange">
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form class="container" action="" method="post">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <label for="" style="font-family:times">Tên tài
                                                                khoản</label>
                                                        </div>
                                                        <div class="col-md-8">
                                                            <input class="input" type="text" id="sp" class="sp"
                                                                name="username">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mt-2">
                                                        <div class="col-md-4">
                                                            <label for="" style="font-family:times">Tên nhân
                                                                viên</label>
                                                        </div>
                                                        <div class="col-md-8"><input class="input" type="text" id="sp"
                                                                class="sp" name="fullname"></div>
                                                    </div>
                                                    <div class="row mt-2">
                                                        <div class="col-md-4">
                                                            <label for="" style="font-family:times">Email</label>
                                                        </div>
                                                        <div class="col-md-8"><input class="input" type="text" id="sp"
                                                                class="sp" name="email"></div>
                                                    </div>
                                                    <div class="row mt-2">
                                                        <div class="col-md-4">
                                                            <label for="" style="font-family:times">Số điện
                                                                thoại</label>
                                                        </div>
                                                        <div class="col-md-8"><input class="input" type="text" id="sp"
                                                                class="sp" name="phone"></div>
                                                    </div>


                                                    <div class="row mt-2">
                                                        <div class="col-md-4">
                                                            <label for="" style="font-family:times">Địa chỉ</label>
                                                        </div>
                                                        <div class="col-md-8"><input class="input" type="text" id="sp"
                                                                class="sp" name="address"></div>
                                                    </div>
                    ...
                    OR address like '%$search%')  order by id asc";
                                    ...
                                    if ($num > 0) {
                                        ...
                                        foreach ($sql as $row) {
                                            ...
                                            echo "<td class='text-center'>NV{$row['id']}</td>";
                                ...
                                <td>' . $value['phone'] . '</td>    
                                <td>' . $value['address'] . '</td> 
                                <td class="text-center"><a href="demote_appoint/appoint.php?id=' . $value['id'] . ' ">  <img src="./img/carreira-png.png"
                                            width="50" height="50"></a></td>
                                <td class="text-center"> 
                                  
                                     <a href="editstaff.php?id=' . $value[0] . '" onclick="return confirm(\'Bạn có chắc chắn  muốn sửa nhân viên này  không\')"> <i class="far fa-edit"></i></a> 
                                     <a href="?id=' . $value[0] . '"  onclick="return confirm(\'Bạn có chắc chắn  muốn xóa nhân viên này  không\')"> <i class="far fa-trash-alt"></i></a> 
