            ...
            <div class="container">
                <div class="signup-content">
                    <form method="POST" id="signup-form" class="signup-form" action="">
                        ...
                        <div class="form-group">
                            <label for="" style="font-weight:600">Mật khẩu</label>
                            <input type="password" class="form-input" name="password" id="name"
                                placeholder="Password" />
                        </div>
                        <div class="form-group">
                            <label for="" style="font-weight:600">Họ và tên</label>
                    ...
                    <p class="loginhere">
                        Đã có tài khoản<a href="./login_admin.php" class="loginhere-link "
                            style="text-decoration:none">Đăng nhập tại đây</a>
                    </p>
