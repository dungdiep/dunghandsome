...
$sql = 'SELECT * FROM color LIMIT ' . $offset . ', ' . $rowsPerPage;
$data = getData($sql);
...
if (isset($_GET['id'])) {
    ...
    // mowr ket noi
    {
        ...
        $sql = 'delete from color where color_id = "' . $_GET['id'] . '"';
        //thực thi câu lệnh
...
if (isset($_POST["submit"])) {
    ...
    if (
        ...
        if (mysqli_num_rows($user)  > 0) {
            ...
            VALUES ( NULL, '$color_name') ";
            // thực thi câu $sql với biến conn 

            mysqli_query($conn, $sql);
            echo '<script language="javascript">';
            echo 'alert("Thêm màu thành công.")';
            echo '</script>';
        }
    }
}
            ...
            <nav class="sb-sidenav accordion" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link " href="./color.php" style="color:orange">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form class="container" action="" method="post">
                                                    <div class="row">
                                                        <div class="col-md-5">
                                                            <label for="" style="font-family:times">Tên màu
                                                            </label>
                                                        </div>
                                                        <div class="col-md-7">
                                                            <input class="input" type="text" id="sp" class="sp"
                                                                name="color_name" style="width:60%">
                                                        </div>
                                                    </div>
                                ...
                                <td class="text-center"> 
                                     <a href="editcolor.php?id=' . $value[0] . '" onclick="return confirm(\'Bạn có chắc chắn  muốn sửa màu sản phẩm này  không\')"> <i class="far fa-edit"></i></a> 
                                ...
                                <?php
                                $conn = new mysqli("localhost", "root", "", DATABASE);
                                $re = mysqli_query($conn, 'select * from color');
