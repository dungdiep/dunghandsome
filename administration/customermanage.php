...
$sql = 'SELECT * FROM account where level=2 LIMIT ' . $offset . ', ' . $rowsPerPage;
$data = getData($sql);
...
if (isset($_POST["submit"])) {
    ...
    if (
        ...
        if (mysqli_num_rows($user)  > 0) {
            ...
            VALUES ( NULL, '$username','$fullname','$email','$phone', '$address','2') ";
            ...
            <nav class="sb-sidenav accordion " id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link " href="./customermanage.php" style="color:orange">
                            <div class="sb-nav-link-icon"><i class="fas fa-users text-white"></i></div>
                            Khách hàng
                        </a>
                    ...
                    OR address like '%$search%')  order by id asc";
                                    ...
                                    if ($num > 0) {
                                        ...
                                        foreach ($sql as $row) {
                                            ...
                                            echo "<td class='text-center'>KH{$row['id']}</td>";
                                ...
                                <td>' . $value['address'] . '</td>
                                <td>
                                 <a href="editcustomer.php?id=' . $value[0] . '" onclick="return confirm(\'Bạn có chắc chắn  muốn sửa khách hàng này  không\')"> <i class="far fa-edit"></i></a> 
