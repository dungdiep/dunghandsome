...
$sql = 'SELECT * FROM brand LIMIT ' . $offset . ', ' . $rowsPerPage;
$data = getData($sql);
...
if (isset($_POST["submit"])) {
    ...
    if (
        ...
        if (mysqli_num_rows($user)  > 0) {
            ...
            echo 'alert("Thêm hãng sản phẩm thành công.")';
            echo '</script>';
        }
    }
}
            ...
            <nav class="sb-sidenav accordion" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link " href="./brand.php" style="color:orange">
                            <div class="sb-nav-link-icon"><i class="fas fa-sitemap text-white"></i></div>
                            Hãng sản phẩm
                        </a>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form class="container" action="" method="post">
                                                    <div class="row">
                                                        <div class="col-md-5">
                                                            <label for="" style="font-family:times">Tên hãng sản
                                                                phẩm</label>
                                                        </div>
                                                        <div class="col-md-7">
                                                            <input class="input" type="text" id="sp" class="sp"
                                                                name="brand_name" style="width:60%">
                                                        </div>
                                                    </div>
                                ...
                                <td class="text-center"> 
                                     <a href="editbrand.php?id=' . $value[0] . '" onclick="return confirm(\'Bạn có chắc chắn  muốn sửa hãng sản phẩm này  không\')"> <i class="far fa-edit"></i></a> 
                                ...
                                <?php
                                $conn = new mysqli("localhost", "root", "", DATABASE);
                                $re = mysqli_query($conn, 'select * from brand');
