...
$sql = 'SELECT * FROM catalog LIMIT ' . $offset . ', ' . $rowsPerPage;
$data = getData($sql);
...
if (isset($_GET['id'])) {
    ...
    // mowr ket noi
    {
        ...
        $sql = 'delete from catalog where catalog_id = "' . $_GET['id'] . '"';
        //thực thi câu lệnh
...
if (isset($_POST["submit"])) {
    ...
    if (
        ...
        $sql = "SELECT * from catalog  where catalog_name='$catalog_name' ";
        ...
        if (mysqli_num_rows($user)  > 0) {
            ...
            $sql = "INSERT INTO catalog ( catalog_id,catalog_name) 
            VALUES ( NULL, '$catalog_name') ";
            ...
            <nav class="sb-sidenav accordion" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link " href="./category.php" style="color:orange">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Thêm doanh mục</h5>
                                            ...
                                            <div class="modal-body">
                                                <form class="container" action="" method="post">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <label for="" style="font-family:times">Tên danh mục</label>
                                                        </div>
                                                        <div class="col-md-8">
                                                            <input class="input" type="text" id="sp" class="sp"
                                                                name="catalog_name" style="width:60%">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <button class="add btn btn-success mt-3" name="submit"
                                ...
                                if (isset($_GET['submit']) && $_GET["search"] != '') {
                                    ...
                                    WHERE (catalog_id like '$search' 
                    
                                    OR catalog_name like '%$search%' )  order by catalog_id asc";
                                    ...
                                    if ($num > 0) {
                                        ...
                                        foreach ($sql as $row) {
                                            ...
                                            echo "<td class='text-center'>MLSP{$row['catalog_id']}</td>";
                                ...
                                <td class="text-center"> 
                                     <a href="editcategory.php?id=' . $value[0] . '" onclick="return confirm(\'Bạn có chắc chắn  muốn sửa danh mục sản phẩm này  không\')"> <i class="far fa-edit"></i></a> 
                                      <a href="?id=' . $value[0] . '"  onclick="return confirm(\'Bạn có chắc chắn  muốn xóa danh mục sản phẩm này  không\')"> <i class="far fa-trash-alt"></i></a> 
                                ...
                                <?php
                                $conn = new mysqli("localhost", "root", "", DATABASE);
                                $re = mysqli_query($conn, 'select * from catalog');
