...
if (isset($_POST['update'])) {
    ...
    if (
        ...
        $sqlUpdate = 'update brand set brand_name = "' . $brand_name . '"
               where brand_id= "' . $id . '" ';
...
<body>
    <div class="heading ">
        <h4 style="font-family:times">Sửa Hãng Sản Phẩm</h4>
    </div>
    ...
    <form action="" class="mt-5 " method="post" style=" height:500px;margin: 0 auto; border-radius: 10px; ">
        ...
        <div class="row">
            <div class="col-md-3">
                <label for="" class="mt-3" style="margin-left: 35px;color: #008080; font-weight: bold;">Tên danh
                    mục</label>
            </div>
            <div class="col-md-9">
                <div class="form-group col-md-12">

                    <input type="text" name="brand_name" id="" class="form-control " value="<?php echo $brand_name ?>"
        ...
        <button class="btn btn" style="margin-left: 20px;"> <a style="color:white; text-decoration: none;"
                href="brand.php">Quay về</a></button>
