...
if (isset($_GET['id'])) {
    ...
    // mowr ket noi
    {
        ...
        //đóng kết nôi
        mysqli_close($conn);
        header("Location: historytransaction.php");
    }
}
?>
...
<?php
    ...
    $sql = 'SELECT t.transaction_id, t.id, t.product_id, t.address, t.quantity,t.earn, t.date , a.fullname, p.product_name, a.address
                            from transaction as t
                            INNER JOIN product as p ON p.product_id = t.product_id
                            INNER JOIN account as a ON a.id  = t.id LIMIT ' . $offset . ', ' . $rowsPerPage;
    $data = getData($sql);
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <nav class="sb-sidenav accordion" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link " href="./historytransaction.php" style="color:orange">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <?php
                                $conn = new mysqli("localhost", "root", "", DATABASE);
                                $re = mysqli_query($conn, 'select * from transaction');
