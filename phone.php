    ...
    <div class="container">
        <div class="col-md-5 mt-2">
            ...
            <a href="smartwatch.php" style="text-decoration: none; color: #00483d; font-weight: 500;"><i
                    class="fas fa-chevron-right mr-1 ml-1"></i>Điện thoại</a>
        </div>
        ...
        if (isset($_GET['submit']) && $_GET["search"] != '') {
            ...
            $query = "select  p.product_id, p.product_name, p.price, p.unit,  p.discount, p.image_link,p.guarantee,p.color_id,
                    ...
                    echo "<div class='col-12 col-lg-3 mt-2 col-6' class='aos-item' data-aos='zoom-in'>
                                        <div class='card' >
                                            <div class='card-body rounded'  style='height: 26rem'>
                                                ...
                                                <hr>
                                                 <h4 class='card-title' style='font-size: 13px; text-align:center; font-weight: bold;'>$row[product_name]</h4>
                                                 <br>
                                                <h4 class='card-title' style='font-size: 15px; text-align:center; color: #000; font-weight: 400;'>" . adddotstring($row['price']) . " <span style='color:red'>VND</span></h4>
                                                <br>
                                ...
                                <div class="card-body ">
                                    ...
                                    <a href="product_detail_unloged.php?product_id=<?php echo $row['product_id']; ?>&catalog_id=<?php echo $row['catalog_id']; ?>&brand_id=<?php echo $row['brand_id']; ?>"
                                        class="product-details" style="text-decoration: none;"><i
                                            class="fas fa-info-circle" style="color: chocolate;float:left"></i> </a>
                                    <a href="">
